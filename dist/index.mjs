...
function Card({
  ...
  return /* @__PURE__ */ React9.createElement(CardContainer, { selected: focus || void 0, type }, header && /* @__PURE__ */ React9.createElement(CardHeader, null, /* @__PURE__ */ React9.createElement(Text, { size: 20, weight: 600 }, header?.title), /* @__PURE__ */ React9.createElement(Text, { size: 14, color: "#CCD0D2" }, header?.subtitle)), children);
}
